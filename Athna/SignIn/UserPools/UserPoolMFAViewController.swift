...
//    var mfaCodeCompletionSource: AWSTaskCompletionSource<AnyObject>?
...
//        self.mfaCodeCompletionSource?.setResult(authenticationCodeValue as AnyObject?)
        self.mfaCodeCompletionSource?.setResult(authenticationCodeValue as NSString?)
    }
...
//    func getCode(_ authenticationInput: AWSCognitoIdentityMultifactorAuthenticationInput, mfaCodeCompletionSource: AWSTaskCompletionSource<AnyObject>) {
